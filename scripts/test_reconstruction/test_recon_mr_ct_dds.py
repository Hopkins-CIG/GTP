...
def run_experiment(
    ...
    def A_cg(x, sigma_meas, lamda):
        return lamda * 1/(sigma_meas**2) * ct_op.A_T(ct_op.A(x)) + x
    ...
    def data_consistency(x, y_meas, diffusion, denoiser, y, sigma, sigma_next, x_T, lamda, dt, sig_t, sigma_meas, i, **kwargs):
        ...
        A_cg_fn = lambda v: A_cg(v, sigma_meas, lamda)
        b_cg = lamda * 1/sigma_meas**2 * ct_op.A_T(y_meas) + x_0_hat
